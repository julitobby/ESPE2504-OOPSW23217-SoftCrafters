...
//            );
//        } else {
//            JOptionPane.showMessageDialog(null, "Usuario no encontrado con ID: " + id, "Aviso", JOptionPane.WARNING_MESSAGE);
//            return null;
//        }
//    }
//
//    public List<User> findUsersByRol(String rol) {
//        List<User> usersByRol = new ArrayList<>();
//
...
//            JOptionPane.showMessageDialog(null, "No se encontraron usuarios con el rol: " + rol, "Aviso", JOptionPane.WARNING_MESSAGE);
//        }
//
//        return usersByRol;
//    }
